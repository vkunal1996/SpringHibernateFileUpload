<%-- 
    Document   : findFail
    Created on : Jan 18, 2018, 5:10:48 PM
    Author     : vkunal1996
--%>
...
<div class="row" style="color:white;" id="menuBar">
    ...
    <center>
        <h2 style="color:black;">Entered Product Id Not Found</h2>
            <P style="color:black; font-size:20px;">  You will Redirect in </P><div id="counter" style="color:black;">5</div> <P style="color:black; font-size:20px;">Seconds </P>
    <script>
        setInterval(function() {
            ...
            if (count == 0) {
                window.location.href="http://localhost:8080/SpringFileUploadAssignment/findProduct.htm";
            }
        }, 1000);
       </script></center>
</body>
